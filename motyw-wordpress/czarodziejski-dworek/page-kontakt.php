...
<section class="section">
  <div class="container split" style="align-items:start">
    ...
    <div class="split__content reveal">
      <div class="card">
        <h2 style="margin-bottom:.4rem"><?php echo esc_html( dworek_field( 'ko_form_title', 'Formularz zapisu' ) ); ?></h2>
    ...
    <div class="split__content reveal" data-delay="1">
      ...
      <h2><?php echo esc_html( dworek_field( 'ko_info_title', 'Jesteśmy do dyspozycji' ) ); ?></h2>
      <p style="margin-bottom:var(--s-3)"><?php echo esc_html( dworek_field( 'ko_info_lead', 'Zapraszamy do kontaktu telefonicznego, mailowego lub osobistej wizyty w naszym przedszkolu na warszawskiej Woli.' ) ); ?></p>

      <!-- Szybki kontakt -->
      <div class="btn-row" style="display:flex;gap:var(--s-2);flex-wrap:wrap;margin-bottom:var(--s-4)">
        <a href="tel:<?php echo esc_attr( dworek_contact( 'phone_link', '+48690629501' ) ); ?>" class="btn btn--primary" style="color:#fff">
        ...
        <a href="mailto:<?php echo esc_attr( dworek_contact( 'email', 'kontakt@czarodziejski-dworek.pl' ) ); ?>" class="btn btn--ghost">
        ...
        <a href="<?php echo esc_url( dworek_contact( 'facebook', 'https://www.facebook.com/czarodziejskidworek/' ) ); ?>" target="_blank" rel="noopener" class="btn btn--ghost">
      ...
      <div class="info-card">
        ...
        <div><strong>Godziny otwarcia</strong><?php echo esc_html( dworek_contact( 'hours', 'Poniedziałek – Piątek: 7.00 – 18.00' ) ); ?></div>
      </div>
...
<section class="section sec-warm">
  <div class="container reveal">
    ...
    <h2 style="text-align:center;margin-bottom:var(--s-2)"><?php echo esc_html( dworek_field( 'ko_doj_title', 'Dojazd i parking' ) ); ?></h2>
    <p class="lead" style="text-align:center;max-width:64ch;margin:0 auto var(--s-5)"><?php echo esc_html( dworek_field( 'ko_doj_lead', 'Znajdujemy się na warszawskiej Woli, przy ul. Górczewskiej 89 — jednej z głównych arterii dzielnicy z dogodnym dojazdem.' ) ); ?></p>
    <div class="split" style="align-items:stretch;gap:var(--s-4)">
      <div class="card split__content" style="height:100%">
        <div class="info-card" style="margin-bottom:0">
          ...
          <div>
            <strong><?php echo esc_html( dworek_field( 'ko_doj1_t', 'Komunikacją miejską' ) ); ?></strong>
            <?php echo esc_html( dworek_field( 'ko_doj1_d', 'Wzdłuż ul. Górczewskiej kursują tramwaje i autobusy, dzięki czemu dojazd z różnych części miasta jest wygodny. Najdogodniejsze połączenie najłatwiej sprawdzić w wyszukiwarce trasy (np. jakdojade.pl) dla adresu Górczewska 89.' ) ); ?>
          </div>
        </div>
      </div>
      <div class="card split__content" style="height:100%">
        <div class="info-card" style="margin-bottom:0">
          ...
          <div>
            <strong><?php echo esc_html( dworek_field( 'ko_doj2_t', 'Samochodem' ) ); ?></strong>
            <?php echo wp_kses_post( dworek_field( 'ko_doj2_d', '<p>Do przedszkola dojadą Państwo bezpośrednio ul. Górczewską. W sprawie najdogodniejszego miejsca na podwiezienie i odebranie dziecka chętnie pomożemy — wystarczy zadzwonić: <a href="tel:+48690629501">690 629 501</a>.</p>' ) ); ?>
          </div>
        </div>
      </div>
    </div>
...
<section class="section">
  <div class="container reveal">
    ...
    <h2 style="text-align:center;margin-bottom:var(--s-2)"><?php echo esc_html( dworek_field( 'ko_docs_title', 'Dokumenty do pobrania' ) ); ?></h2>
    <p class="lead" style="text-align:center;max-width:62ch;margin:0 auto var(--s-5)"><?php echo esc_html( dworek_field( 'ko_docs_lead', 'Sprawdź aktualne informacje dotyczące naszego przedszkola!' ) ); ?></p>
    <div class="docs-grid">
