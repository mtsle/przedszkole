 ...
 *
 * Wygląd 1:1 z oferta.html. Układ stały, zdjęcia i ikony w kodzie.
 * CAŁY TEKST edytowalny z panelu (pola ACF — grupa „Program — treść strony").
 * Bez ACF motyw działa: dworek_field() zwraca treść domyślną.
 *
...
<section class="section prog-zajecia sec-warm">
  <div class="container">
    <div class="section-head reveal">
      ...
      <h2><?php echo esc_html( dworek_field( 'pr_zaj_title', 'Poznaj nasze zajęcia' ) ); ?></h2>
      <p><?php echo esc_html( dworek_field( 'pr_zaj_lead', 'Basen, język angielski i francuski oraz muzyka są w cenie czesnego.' ) ); ?></p>
    </div>
    <div class="faq prog-acc">
      ...
      <details>
        <summary>
          ...
          <span class="acc-head"><span><?php echo esc_html( dworek_field( 'pr_acc6_t', 'Joga i zajęcia taneczne' ) ); ?></span><small><?php echo esc_html( dworek_field( 'pr_acc6_m', 'Ruch, relaks i poczucie rytmu' ) ); ?></small></span>
          <span class="plus">+</span>
        </summary>
        <div class="faq__a">
          <?php echo wp_kses_post( dworek_field( 'pr_acc6_b', '<p>Joga to spokojne ćwiczenia wspierające koncentrację, równowagę i relaks — uczą dzieci wyciszenia i świadomości własnego ciała.</p><p>Zajęcia taneczne prowadzi szkoła tańca PRO-DANCE. To radosna forma ruchu, która rozwija koordynację, poczucie rytmu i pewność siebie, a przy okazji świetnie integruje grupę.</p>' ) ); ?>
          <div class="photo-row">
      ...
      <details>
        <summary>
          ...
          <span class="acc-head"><span><?php echo esc_html( dworek_field( 'pr_acc7_t', 'Warsztaty, wycieczki i „zielone noce”' ) ); ?></span><small><?php echo esc_html( dworek_field( 'pr_acc7_m', 'Wydarzenia poza codziennymi zajęciami' ) ); ?></small></span>
          <span class="plus">+</span>
        </summary>
        <div class="faq__a">
          <?php echo wp_kses_post( dworek_field( 'pr_acc7_b', '<p>Poza codziennymi zajęciami organizujemy warsztaty edukacyjne, wycieczki oraz „zielone noce” — wyjątkowe wydarzenia, które integrują dzieci, rozbudzają ciekawość i poszerzają ich horyzonty. To chwile, które na długo zostają w pamięci najmłodszych.</p>' ) ); ?>
          <div class="photo-row">
...
<section class="section">
  <div class="container">
    <div class="section-head reveal">
      ...
      <h2><?php echo esc_html( dworek_field( 'pr_soc_title', 'Uczymy emocji i bycia razem' ) ); ?></h2>
      <p><?php echo esc_html( dworek_field( 'pr_soc_lead', 'Program wspiera nie tylko wiedzę, ale też relacje, emocje i umiejętność współpracy.' ) ); ?></p>
    </div>
    <div class="grid cols-3 feat-grid">
      <article class="card reveal">
        ...
        <h3><?php echo esc_html( dworek_field( 'pr_soc1_t', 'Wyrażanie emocji' ) ); ?></h3>
        <p><?php echo esc_html( dworek_field( 'pr_soc1_d', 'Muzyka pozwala dzieciom wyrażać emocje i wrażliwość oraz rozwijać ekspresję — w bezpieczny, twórczy sposób.' ) ); ?></p>
      </article>
      <article class="card reveal" data-delay="1">
        ...
        <h3><?php echo esc_html( dworek_field( 'pr_soc2_t', 'Integracja grupy' ) ); ?></h3>
        <p><?php echo esc_html( dworek_field( 'pr_soc2_d', 'Taniec animacyjny (metoda KLANZA) łączy ruch, rytm i śpiew — służy relaksacji i integracji całej grupy.' ) ); ?></p>
      </article>
      <article class="card reveal" data-delay="2">
        ...
        <h3><?php echo esc_html( dworek_field( 'pr_soc3_t', 'Współpraca i fair play' ) ); ?></h3>
        <p><?php echo esc_html( dworek_field( 'pr_soc3_d', 'Na zajęciach ruchowych dzieci uczą się zasad fair play — zarówno cieszenia się z wygranej, jak i radzenia sobie z porażką.' ) ); ?></p>
      </article>
    </div>
  </div>
</section>
...
<section class="section sec-warm">
  <div class="container">
    <div class="section-head reveal">
      ...
      <h2><?php echo esc_html( dworek_field( 'pr_sam_title', 'Wspieramy samodzielność i twórczy rozwój' ) ); ?></h2>
      <p><?php echo esc_html( dworek_field( 'pr_sam_lead', 'Dziecko jest aktywnym twórcą swojego rozwoju — my dajemy mu przestrzeń i narzędzia.' ) ); ?></p>
    </div>
    <div class="grid cols-3 feat-grid">
      <article class="card reveal">
        ...
        <h3><?php echo esc_html( dworek_field( 'pr_sam1_t', 'Własne tempo' ) ); ?></h3>
        <p><?php echo esc_html( dworek_field( 'pr_sam1_d', 'Podmiotowe traktowanie dziecka i program dostosowany do jego możliwości budują samodzielność i wiarę we własne siły.' ) ); ?></p>
      </article>
      <article class="card reveal" data-delay="1">
        ...
        <h3><?php echo esc_html( dworek_field( 'pr_sam2_t', 'Twórczość i wyobraźnia' ) ); ?></h3>
        <p><?php echo esc_html( dworek_field( 'pr_sam2_d', 'Nieograniczony dostęp do materiałów plastycznych oraz muzyka rozwijają twórczość, wyobraźnię i kreatywność.' ) ); ?></p>
      </article>
      <article class="card reveal" data-delay="2">
        ...
        <h3><?php echo esc_html( dworek_field( 'pr_sam3_t', 'Ciekawość świata' ) ); ?></h3>
        <p><?php echo esc_html( dworek_field( 'pr_sam3_d', 'Rozbudzamy ciekawość poznawczą — dzieci poznają sztukę, matematykę i przyrodę, także podczas zajęć językowych.' ) ); ?></p>
      </article>
    </div>
  </div>
</section>
...
<section class="section cta-band">
  <div class="container">
    <div class="card reveal">
      <h2><?php echo esc_html( dworek_field( 'pr_cta_title', 'Chcesz poznać szczegóły i zapisać dziecko?' ) ); ?></h2>
      <p style="margin-inline:auto"><?php echo esc_html( dworek_field( 'pr_cta_text', 'Skontaktuj się z nami — opowiemy o programie, dostępnych grupach i warunkach zapisu, a także zaprosimy na zwiedzanie przedszkola. Wizyta jest bezpłatna i bez zobowiązań.' ) ); ?></p>
      <div class="btn-row"><a href="<?php echo esc_url( home_url( '/kontakt/' ) ); ?>" class="btn btn--primary btn--lg"><?php echo esc_html( dworek_field( 'pr_cta_btn1', 'Zapytaj o zapisy' ) ); ?></a><a href="<?php echo esc_url( home_url( '/wsparcie/' ) ); ?>" class="btn btn--ghost btn--lg"><?php echo esc_html( dworek_field( 'pr_cta_btn2', 'WWR i terapia' ) ); ?></a></div>
    </div>
  </div>
</section>
