...
<footer class="site-footer">
	<div class="container footer-grid">
		<div class="footer-brand">
			...
			<div class="social">
				<a href="<?php echo esc_url( dworek_contact( 'facebook', 'https://www.facebook.com/czarodziejskidworek/' ) ); ?>" target="_blank" rel="noopener" aria-label="Facebook"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M14 9h3V6h-3c-1.7 0-3 1.3-3 3v2H9v3h2v7h3v-7h2.5l.5-3H14V9z"/></svg></a>
		...
		<div>
			<h2>Kontakt</h2>
			<ul class="footer-links">
				<li><?php echo esc_html( dworek_contact( 'address', 'ul. Górczewska 89, 01-401 Warszawa (Wola)' ) ); ?></li>
